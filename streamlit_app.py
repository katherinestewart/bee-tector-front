...
# URL = st.secrets.get("API_URL") or os.getenv("API_URL") or "https://imageapi-646220559180.europe-west1.run.app"
API_URL = "http://localhost:8000"
st.title("BeeTector")

country_codes = [c.alpha_2 for c in pycountry.countries]
selected_country = st.selectbox("Select a country (ISO-2, optional)", [""] + country_codes)
